...
import (
	...
	"github.com/lishimeng/file-server/cmd/file-server/ddd"
	"github.com/lishimeng/file-server/cmd/file-server/setup"
	"github.com/lishimeng/file-server/cmd/file-server/static"
